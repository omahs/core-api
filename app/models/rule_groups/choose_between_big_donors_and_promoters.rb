class ChooseBetweenBigDonorsAndPromoters < RuleGroup
  ...
  def call(input = {})
    ...
    return big_donors_response if contributions_from_big_donors(chosen_contributions).empty?
    return promoters_response  if contributions_from_promoters(chosen_contributions).empty?
