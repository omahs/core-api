...
RSpec.describe ChooseBetweenBigDonorsAndPromoters, type: :model do
  ...
  let(:big_donor_person_payment) { create(:person_payment, payer: big_donor, crypto_value_cents: 100) }
  let(:customer_person_payment) { create(:person_payment, payer: customer, crypto_value_cents: 100) }
