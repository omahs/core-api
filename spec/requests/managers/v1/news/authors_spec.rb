...
RSpec.describe 'Managers::V1::News::Authors', type: :request do
  describe 'GET /index' do
    subject(:request) { get '/managers/v1/news/authors' }
  ...
  describe 'GET /show' do
    subject(:request) { get "/managers/v1/news/authors/#{author.id}" }
  ...
  describe 'POST /create' do
    subject(:request) { post '/managers/v1/news/authors', params: }
  ...
  describe 'PUT /update' do
    subject(:request) { put "/managers/v1/news/authors/#{author.id}", params: }
