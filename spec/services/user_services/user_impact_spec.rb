...
RSpec.describe UserServices::UserImpact, type: :service do
  describe '#impact' do
    ...
    let(:non_profit1) do
      create(:non_profit, :with_impact, wallet_address: '0xf20c382d2a95eb19f9164435aed59e5c59bc1fd9')
    end
    let(:non_profit2) do
      create(:non_profit, :with_impact, wallet_address: '0xg20c382d2a95eb19f9164435aed59e5c59bc1fd9')
    end
