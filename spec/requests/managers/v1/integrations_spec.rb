...
RSpec.describe 'Managers::V1::Integrations', type: :request do
  describe 'GET /index' do
    subject(:request) { get '/managers/v1/integrations' }
  ...
  describe 'POST /create' do
    subject(:request) { post '/managers/v1/integrations', params: }
  ...
  describe 'GET /show' do
    context 'when id is numeric' do
      subject(:request) { get "/managers/v1/integrations/#{integration.id}" }
      ...
      context 'when id is uuid' do
        subject(:request) { get "/managers/v1/integrations/#{integration.unique_address}" }
  ...
  describe 'PUT /update' do
    subject(:request) { put "/managers/v1/integrations/#{integration.id}", params: }
