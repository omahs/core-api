...
ActiveRecord::Schema[7.0].define(version: 20_221_003_174_403) do
  ...
  create_table 'api_keys', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[bearer_type bearer_id], name: 'index_api_keys_on_bearer'
  end
  ...
  create_table 'mobility_string_translations', force: :cascade do |t|
    ...
    t.index %w[translatable_type key value locale],
  ...
  create_table 'user_managers', force: :cascade do |t|
    ...
    t.index %w[uid provider], name: 'index_user_managers_on_uid_and_provider', unique: true
  end
