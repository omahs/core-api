...
RSpec.describe 'Managers::V1::News::Articles', type: :request do
  describe 'GET /index with 2 articles available' do
    subject(:request) { get '/managers/v1/news/articles' }
  ...
  describe 'GET /index with 2 hidden articles' do
    subject(:request) { get '/managers/v1/news/articles?show_hidden_articles=true' }
  ...
  describe 'GET /index with an 8 items pagination' do
    subject(:request) { get '/managers/v1/news/articles?page=1&per=8' }
  ...
  describe 'GET /show' do
    subject(:request) { get "/managers/v1/news/articles/#{article.id}" }
  ...
  describe 'POST /create' do
    subject(:request) { post '/managers/v1/news/articles', params: article_params }
  ...
  describe 'PUT /update' do
    subject(:request) { put "/managers/v1/news/articles/#{article.id}", params: article_params }
