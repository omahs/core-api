    ...
    class CalculateImpactToNonProfit < ApplicationCommand
      ...
      def call
        with_exception_handle do
          { impact: impact_service.impact, rounded_impact: impact_service.rounded_impact, impact_unit: }
        end
      end
      ...
      def impact_unit
        @impact_unit ||= non_profit.impact_for&.measurement_unit || 'quantity_without_decimals'
      end
